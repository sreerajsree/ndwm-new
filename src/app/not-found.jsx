  ...
  return (
    <Container className="flex h-full items-center pt-20 sm:pt-24 lg:pt-32">
      <FadeIn className="flex flex-col items-center">
        <p className="font-display text-4xl font-semibold text-indigo-900 sm:text-5xl">
          404
        </p>
        ...
        <Link
          href="/"
          className="mt-4 text-sm font-semibold text-indigo-900 transition hover:text-neutral-700"
        >
          Go to the home page
        </Link>
      </FadeIn>
